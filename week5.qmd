...
### Practical result
In the practical part, we've chosen Delhi as the study area. Firstly, we loaded the Landsat-9 data into GEE. Next, we downloaded the shape files of Delhi from GADM
