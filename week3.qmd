...
The figure below shows the ratio enhancement of vegetation with the aid of NDVI index (above 0.2): ![Ratio enhancement](img/wk3.jpg) Form the graph, it can be viewed that the healthy vegetation in Cape Town is shown as green. And the ocean and other places without healthy vegetation is shown as white.
