...
For instance, by using the factors above, the UGF can be calculated by:
(Factor A x Area) + (Factor B x Area) + (Factor C x Area) etc. divided by Total Site 
Area.
The Mayor recommends a target score of 0.4 for residential developments and 0.3 for commercial development.
